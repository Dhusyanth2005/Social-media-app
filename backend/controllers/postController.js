...
const likeUnlikePost = async (req, res) => {
	try {
		...
		if (userLikedPost) {
			// Unlike post
			await Post.updateOne({ _id: postId }, { $pull: { likes: userId } });//remove the user id
...
export  {createPost,getPost,getFeedPosts,deletePost,likeUnlikePost,replyToPost,getUserPosts};